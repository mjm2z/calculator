...
describe('Reducer Tests', () => {
    ...
    it('Given the reducer is called with an action with type EQUATION and an invalid equation, it should return the correct equation and display value', ()=>{
        ...
        let stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "" });
        expect(stateAfter).toEqual(expectedState1);
        const expectedState2 = {currentEquation: "abc", displayValue: "NaN"}
        stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "abc" });
    ...
    it('Given the reducer is called with an action with type EQUATION and valid equation, it should return the correct equation and display value', ()=>{
        const expectedState1 = {currentEquation: "123+456-(-78)*9", displayValue: "9"}
        let stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "123+456-(-78)*9" });
        expect(stateAfter).toEqual(expectedState1);
        const expectedState2 = {currentEquation: "123456789", displayValue: "123456789"}
        stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "123456789" });
        expect(stateAfter).toEqual(expectedState2);
        const expectedState3 = {currentEquation: "0.004", displayValue: "0.004"}
        stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "0.004" });
        expect(stateAfter).toEqual(expectedState3);
        const expectedState4 = {currentEquation: "18*(-0.008", displayValue: "-0.008"}
        stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "18*(-0.008" });
        expect(stateAfter).toEqual(expectedState4);
        const expectedState5 = {currentEquation: "(-123.45)+(-18)", displayValue: "-18"}
        stateAfter = reducers.equation(initialState, {type: "EQUATION", equation: "(-123.45)+(-18)" });
